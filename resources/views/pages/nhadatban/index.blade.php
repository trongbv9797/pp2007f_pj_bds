        ...
        <form id="boxSearchForm" action="/microservice-architecture-router/Product/ProductSearch/Index" method="post"
            ...
            <div class="search-bar shadow-lv-1 clearfix">
                ...
                <div id="divCategoryRe" class="select-control select-cate">
                    ...
                    <input data-val="true" data-val-required="The SubCateId field is required." id="hdCboCatagory"
                        name="SubCateId" type="hidden" value="0">
                    <div id="select-cate-options"
                        class="custom-dropbox-cate hiding advance-select-options custom-scroll mCustomScrollbar _mCS_3 mCS_no_scrollbar"
                        style="display: none;">
                ...
                <div class="select-control city-control">
                    ...
                    <div class="select-context custom-dropbox advance-select-options hiding" id="divCity"
                        style="display: none;">
                        <div class="city-root hiding"></div>
                        <input type="text" id="select-context-content" class="select-text-content"
                            placeholder="Tìm Tỉnh/ Thành phố">
                        <input type="hidden" name="CityCode" id="hdCboCity" value="CN">
                        <input type="hidden" name="DistrictId" id="hdCboDistrict" value="">
                        <div id="divCityOptions" class="custom-scroll mCustomScrollbar _mCS_4 mCS_no_scrollbar"
                            hddvalue="hdCboCity,hdCboDistrict" defaulttext="Toàn quốc" ddlid="divCity" currlevel="1"
                            style="">
                ...
                <div class="select-control price-control">
                    ...
                    <div id="divPrice" class="select-area-option custom-dropbox hiding advance-select-options"
                        style="display: none;">
                        ...
                        <div class="pad-bot-40 pad-top-8">
                            <div class="price-slider-range slider-range">
                                <input id="txtPriceMinValue" name="MinPrice" placeholder="Từ"
                                    class="min-value advance-options" maxlength="6" numbersonly="true" decimal="true"
                                    type="text">
                                <span><img src="./assets/image/ic_arrow_left.png"></span>
                                <input id="txtPriceMaxValue" name="MaxPrice" placeholder="Đến"
                                    class="max-value advance-options" maxlength="6" numbersonly="true" decimal="true"
                                    type="text">
                                <div class="clearfix pad-bot-16"></div>
                                <div id="price-slider-range"
                                    class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all">
                                    <div class="ui-slider-range ui-widget-header" style="left: 0%; width: 100%;"></div><a
                                        href="#" class="ui-slider-handle ui-state-default ui-corner-all"
                                        style="left: 0%;"></a><a href="#"
                                        class="ui-slider-handle ui-state-default ui-corner-all" style="left: 100%;"></a>
                                </div>
                            </div>
                            <div class="custom-scroll mCustomScrollbar _mCS_5 mCS_no_scrollbar" id="divPriceOptions"
                                minvalue="txtPriceMinValue" maxvalue="txtPriceMaxValue" unit="money" lblmin="lblPriceMin"
                                lblmax="lblPriceMax" hddvalue="hdCboPrice" defaulttext="Tất cả" ddlid="divPrice"
                                currlevel="1" style="">
                                <div id="mCSB_5" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside"
                                    ...
                                    <div id="mCSB_5_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y"
                                        ...
                                        <ul class="advance-options">
                                            ...
                                            <li vl="2" class="advance-options">500<span class="arrow-icon"></span>800 triệu
                                            </li>
                                            <li vl="3" class="advance-options">800 triệu<span class="arrow-icon"></span>1 tỷ
                                            </li>
                ...
                <div class="select-control area-control">
                    ...
                    <div id="divArea" class="select-area-option custom-dropbox hiding advance-select-options"
                        style="display: none;">
                        <input type="hidden" id="hdCboArea" name="AreaId" value="-1">
                        <div class="pad-bot-40 pad-top-8">
                            <div class="area-slider-range slider-range">
                                <input id="txtAreaMinValue" name="MinArea" placeholder="Từ" class="min-value" maxlength="6"
                                    numbersonly="true" decimal="true" type="text">
                                <span><img src="./assets/image/ic_arrow_left.png"></span>
                                <input id="txtAreaMaxValue" name="MaxArea" placeholder="Đến" class="max-value" maxlength="6"
                                    numbersonly="true" decimal="true" type="text">
                                <div class="clearfix pad-bot-16"></div>
                            ...
                            <div class="custom-scroll mCustomScrollbar _mCS_6 mCS_no_scrollbar" id="divAreaOptions"
                                minvalue="txtAreaMinValue" maxvalue="txtAreaMaxValue" unit="area" hddvalue="hdCboArea"
                                defaulttext="Tất cả" ddlid="divArea" currlevel="1" style="">
                                <div id="mCSB_6" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside"
                                    ...
                                    <div id="mCSB_6_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y"
                                        ...
                                        <ul>
                                            ...
                                            <li vl="2" class="advance-options">30 m²<span class="arrow-icon"></span>50 m²
                                            </li>
                                            <li vl="3" class="advance-options">50 m²<span class="arrow-icon"></span>80 m²
                                            </li>
                                            <li vl="4" class="advance-options">80 m²<span class="arrow-icon"></span>100 m²
                                            </li>
                                            <li vl="5" class="advance-options">100 m²<span class="arrow-icon"></span>150 m²
                                            </li>
                                            <li vl="6" class="advance-options">150 m²<span class="arrow-icon"></span>200 m²
                                            </li>
                                            <li vl="7" class="advance-options">200 m²<span class="arrow-icon"></span>250 m²
                                            </li>
                                            <li vl="8" class="advance-options">250 m²<span class="arrow-icon"></span>300 m²
                                            </li>
                                            <li vl="9" class="advance-options">300 m²<span class="arrow-icon"></span>500 m²
                                            </li>
                ...
                <div class="select-control project-control" aria-label="Bạn hãy chọn tỉnh thành trước"
                    ...
                    <div id="divProjects" class="select-context custom-dropbox advance-select-options hiding"
                        style="display: none;">
                        <input type="hidden" id="hdCboProjects" name="ProjectId" value="0">
                        <input type="text" class="select-text-content" placeholder="Tìm Dự án">
                        <div id="divProjectsOptions" class="custom-scroll mCustomScrollbar _mCS_7 mCS_no_scrollbar"
                            hddvalue="hdCboProjects" defaulttext="Tất cả" ddlid="divProjects" currlevel="1" style="">
                ...
                <div class="select-control filter-control">
                    <div class="select-control-label" aria-label="Tìm kiếm nâng cao" data-microtip-position="top"
                        role="tooltip">
                        Lọc thêm<span class="filter-info"><img src="./assets/image/ic_filter.svg" class="icon-filter"><span
                                class="icon-number" style="display: none;"></span></span>
                    </div>
                    <input type="hidden" id="hdbFilter" value="0">
                    <div class="select-filter-dropbox custom-dropbox advance-select-options hiding"
                        style="display: none; height: 516px;">
                        <div class="custom-scroll-outside mCustomScrollbar _mCS_9 mCS_no_scrollbar"
                            style="position: relative; overflow: visible; max-height: 460px;">
                            <div id="mCSB_9" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_outside"
                                style="max-height: 0px;" tabindex="0">
                                <div id="mCSB_9_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y"
                                    ...
                                    <div class="relative-control select-context">
                                        ...
                                        <div id="divWard" class="relative-control"
                                            aria-label="Bạn hãy chọn quận huyện trước" data-microtip-position="top"
                                            role="tooltip">
                                            <div class="filter-label"><span>Tất cả phường, xã</span><i
                                                    class="icon-arrow icon-arrow-down"></i></div>
                                            <input type="hidden" id="hdCboWard" name="WardId" value="0">
                                            <input type="text" placeholder="Tìm Phường, Xã"
                                                class="select-text-content icon-arrow-up hiding" style="display: none;">
                                        </div>
                                    </div>

                                    <div class="relative-control select-context">
                                        <label>Đường/ Phố</label>
                                        <div id="divStreet" class="relative-control"
                                            aria-label="Bạn hãy chọn tỉnh thành trước" data-microtip-position="top"
                                            role="tooltip">
                                            <div class="filter-label"><span>Tất cả đường, phố</span><i
                                                    class="icon-arrow icon-arrow-down"></i></div>
                                            <input type="hidden" id="hdCboStreet" name="StreetId" value="0">
                                            <input type="text" placeholder="Tìm Đường/ Phố"
                                                class="select-text-content hiding icon-arrow-up" style="display: none;">
                                        </div>
                                    </div>
                                    ...
                                    <div id="divBedRoom" class="select-bedroom ul-new clearfix">
                                        ...
                                        <div id="divBedRoomOptions" hddvalue="hdCboBedRoom" ddlid="divBedRoom"
                                            currlevel="1">
                                            <ul>
                                    ...
                                    <div class="relative-control select-context">
                                        ...
                                        <div id="divHomeDirection" class="relative-control">
                                            <div class="filter-label"><span>Tất cả hướng nhà</span><i
                                                    class="icon-arrow icon-arrow-down"></i></div>
                                            <input type="text" placeholder="Tìm hướng nhà" value="Tất cả hướng nhà"
                                                class="select-text-content hiding icon-arrow-up" style="display: none;">
                    ...
                    <!--khuvu loc them -->
                    <div id="divWardOptions" ddlid="divWard"
                        class="fly-options custom-dropbox custom-dropbox hiding  advance-select-options mCustomScrollbar _mCS_1 mCS_no_scrollbar"
                        hddvalue="hdCboWard" isfilter="true" currlevel="1" style="display: none;">
                        <div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside"
                            style="max-height: 48px;" tabindex="0">
                    ...
                    <div id="divStreetOptions" ddlid="divStreet"
                        class="fly-options custom-dropbox custom-dropbox hiding advance-select-options mCustomScrollbar _mCS_2 mCS_no_scrollbar"
                        hddvalue="hdCboStreet" isfilter="true" currlevel="1" style="display: none;">
                    ...
                    <div id="divHomeDirectionOptions" ddlid="divHomeDirection"
                        class="hiding fly-options custom-dropbox custom-scroll advance-select-options mCustomScrollbar _mCS_8 mCS_no_scrollbar"
                        hddvalue="hdCboHomeDirection" isfilter="true" currlevel="1" style="display: none;">
                        <div id="mCSB_8" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside"
                            style="max-height: 308px;" tabindex="0">
                ...
                <div id="link-reset" aria-label="Xóa tiêu chí lọc" data-microtip-position="bottom-left" role="tooltip"><img
                        src="./assets/image/ic_reset.svg"></div>
            </div>
        </form>
            ...
            (function getData() {
                if (window.FrontEnd && window.FrontEnd.BoxSearch) {
                    ...
                    boxSearchServices.GetData().then(function(data) {
                        (function callJQuery() {
                            if (window.FrontEnd && window.FrontEnd.Product && window.FrontEnd.Product
                                .BoxProductSearchBinnova) {
        ...
        <div class="main-container clearfix">
            <div class="main-left">
                ...
                <div class="breadcrumb all-grey-7 link-hover-blue">
                    <a href="https://batdongsan.com.vn/nha-dat-ban" level="1"
                        title="Nhà đất bán tại Việt Nam">Bán</a><span>/</span><a
                        href="https://batdongsan.com.vn/nha-dat-ban" level="2" title="Nhà đất bán tại Việt Nam">Tất cả BĐS
                        trên toàn quốc</a>
                </div>
                <script type="text/javascript">
                    (function callJQuery() {
                ...
                <div class="product-list-header pad-top-8">
                    ...
                    <div class="product-lists-count all-grey-7 pad-top-8 pad-bot-8">Hiện có <span
                            id="count-number">183,364</span> bất động sản.</div>
                ...
                <div class="product-lists mar-top-16" id="product-lists-web" style="display:block">
                    <div class="tag_container">
                        @include('pages.nhadatban.presult')
                    </div>
                </div>
                ...
                <div class="product-seo-tag">
                    ...
                    <ul class="ul-round clearfix">
                        <li><a title="Bán đất gần làng đại học Thủ Đức"
                                href="https://batdongsan.com.vn/tags/ban/ban-dat-gan-lang-dai-hoc-thu-duc">Bán đất gần làng
                                đại học Thủ Đức</a></li>
                        <li><a title="Bán nhà chính chủ" href="https://batdongsan.com.vn/tags/ban/ban-nha-chinh-chu">Bán nhà
                                chính chủ</a></li>
                        <li><a title="Bán nhà gần công viên Lê Thị Riêng"
                                href="https://batdongsan.com.vn/tags/ban/ban-nha-gan-cong-vien-le-thi-rieng">Bán nhà gần
                                công viên Lê Thị Riêng</a></li>
                        <li><a title="Bán chung cư chính chủ"
                                href="https://batdongsan.com.vn/tags/ban/ban-chung-cu-chinh-chu">Bán chung cư chính chủ</a>
                        </li>
                        <li><a title="Bán đất chính chủ" href="https://batdongsan.com.vn/tags/ban/ban-dat-chinh-chu">Bán đất
                                chính chủ</a></li>
                        <li><a title="Bán nhà mặt phố gIÁ RẺ"
                                href="https://batdongsan.com.vn/tags/ban/ban-nha-mat-pho-gia-re">Bán nhà mặt phố gIÁ RẺ</a>
                        </li>
                    </ul>
                </div>
                <div class="divide">&nbsp;</div>
                <div class="product-seo-text">
                    <div>Hàng nghìn tin đăng <strong>mua bán nhà đất tại Việt Nam</strong> được rao trên
                        ...
                        chọn đối với bất động sản đang quan tâm.
                    </div>
                ...
                <form id="productListBinnova" method="post">
                    <input id="hashAlias" type="hidden"
                        value="48f0d40b1731d909212598242194556c2306f2dde9c6827fab303276aa8fec92">
                </form>
                <script type="text/javascript">
                    (function callJQuery() {
            ...
            <div class="main-right">
                ...
                <div class="box-common box-common-border box-price fixgradient">
                    ...
                    <div class="box-content">
                        <ul class="link-hover-blue height">
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/2/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 500 - 800 triệu">500 - 800 triệu</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/3/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 800 triệu - 1 tỷ">800 triệu - 1 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/4/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 1 - 2 tỷ">1 - 2 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/5/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 2 - 3 tỷ">2 - 3 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/6/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 3 - 5 tỷ">3 - 5 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/7/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 5 - 7 tỷ">5 - 7 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/8/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 7 - 10 tỷ">7 - 10 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/9/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 10 - 20 tỷ">10 - 20 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/10/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá 20 - 30 tỷ">20 - 30 tỷ</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/-1/11/-1/-1"
                                    title="Mua bán nhà đất toàn quốc giá &gt; 30 tỷ">&gt; 30 tỷ</a></li>
                        </ul>
                ...
                <div class="box-common box-common-border box-price fixgradient">
                    ...
                    <div class="box-content">
                        <ul class="link-hover-blue height">
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/1/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích &lt;= 30 m2">&lt;= 30 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/2/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 30 - 50 m2">30 - 50 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/3/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 50 - 80 m2">50 - 80 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/4/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 80 - 100 m2">80 - 100 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/5/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 100 - 150 m2">100 - 150 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/6/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 150 - 200 m2">150 - 200 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/7/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 200 - 250 m2">200 - 250 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/8/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 250 - 300 m2">250 - 300 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/9/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích 300 - 500 m2">300 - 500 m2</a></li>
                            <li><a href="https://batdongsan.com.vn/nha-dat-ban/10/-1/-1/-1"
                                    title="Mua bán nhà đất toàn quốc diện tích &gt;= 500 m2">&gt;= 500 m2</a></li>
                        </ul>
                        <div class="box-view-more ">
                            <a href="javascript:void(0);" class="box-product-right-viewmore">
                                <div class="gradient">&nbsp;</div>
                ...
                <div class="box-common box-common-filled box-max-item-cate">
                    ...
                    <div class="box-content link-hover-blue">
                        <ul>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-tp-hcm"
                                        title="Mua bán nhà đất tại Hồ Chí Minh">
                                        Hồ Chí Minh (72034)
                                    </a>
                                </h3>
                            </li>
                            ...
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-binh-duong"
                                        title="Mua bán nhà đất tại Bình Dương">
                                        Bình Dương (10821)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-dong-nai"
                                        title="Mua bán nhà đất tại Đồng Nai">
                                        Đồng Nai (7487)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-ba-ria-vung-tau"
                                        title="Mua bán nhà đất tại Bà Rịa Vũng Tàu">
                            ...
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-hai-phong"
                                        title="Mua bán nhà đất tại Hải Phòng">
                                        Hải Phòng (2506)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-binh-thuan"
                                        title="Mua bán nhà đất tại Bình Thuận  ">
                                        Bình Thuận (1780)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-quang-ngai"
                                        title="Mua bán nhà đất tại Quảng Ngãi">
                                        Quảng Ngãi (215)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-khanh-hoa"
                                        title="Mua bán nhà đất tại Khánh Hòa">
                                        Khánh Hòa (3493)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-nghe-an"
                                        title="Mua bán nhà đất tại Nghệ An">
                                        Nghệ An (210)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-yen-bai"
                                        title="Mua bán nhà đất tại Yên Bái">
                                        Yên Bái (24)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-quang-tri"
                                        title="Mua bán nhà đất tại Quảng Trị">
                                        Quảng Trị (30)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-thai-binh"
                                        title="Mua bán nhà đất tại Thái Bình">
                                        Thái Bình (67)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-ben-tre"
                                        title="Mua bán nhà đất tại Bến Tre">
                                        Bến Tre (88)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-dien-bien"
                                        title="Mua bán nhà đất tại Điện Biên">
                                        Điện Biên (3)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-ca-mau"
                                        title="Mua bán nhà đất tại Cà Mau">
                                        Cà Mau (23)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-dak-lak"
                                        title="Mua bán nhà đất tại Đắk Lắk">
                                        Đắk Lắk (110)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-hoa-binh"
                                        title="Mua bán nhà đất tại Hòa Bình">
                                        Hòa Bình (1541)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-son-la"
                                        title="Mua bán nhà đất tại Sơn La">
                                        Sơn La (6)
                                    </a>
                                </h3>
                            </li>
                            <li>
                                <h3>
                                    <a href="https://batdongsan.com.vn/nha-dat-ban-binh-dinh"
                                        title="Mua bán nhà đất tại Bình Định">
                                        Bình Định (403)
                                    </a>
                                </h3>
                            </li>
                        ...
                        <ul>
                            <li>
                                <a href="https://batdongsan.com.vn/ho-tro-tien-ich/ht-xem-huong-nha"
                                    title="Tư vấn phong thủy" rel="nofollow">
                                    Tư vấn phong thủy
                                </a>
                            </li>
                            <li>
                                <a href="https://batdongsan.com.vn/ho-tro-tien-ich/ht-du-toan-chi-tiet"
                                    title="Dự tính chi phí làm nhà" rel="nofollow">
                                    Dự tính chi phí làm nhà
                                </a>
                            </li>
                            <li>
                                <a href="https://batdongsan.com.vn/ho-tro-tien-ich/ht-tinh-lai-suat" title="Tính lãi suất"
                                    rel="nofollow">
                                    Tính lãi suất
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="https://batdongsan.com.vn/ho-tro-tien-ich/ht-xem-tuoi-xay-nha"
                                    title="Xem tuổi làm nhà" rel="nofollow">Xem tuổi làm nhà</a>
                            </li>
                        </ul>
                    </div>
                </div>
