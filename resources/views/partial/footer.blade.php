        ...
        <div class="footer-col1">
            <div class="footer-logo">
                <a href="https://batdongsan.com.vn/">
                    <img src="./assets/image/logo-footer-no1.svg" noloaderror="true" onerror="this.src='https://staticfile.batdongsan.com.vn/image/logo-footer-no1.png'">
                </a>
            </div>
                            ...
                            <ul id="country">
                                <li>
                                    <a target="_blank" href="http://www.rumah.com/" title="Indonesia Real Estate">
                                        <img src="./assets/image/indonesia.png" alt="Indonesia Real Estate">Indonesia
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a target="_blank" href="http://www.propertyguru.com.sg/" title="Singapore Real Estate">
                                        <img src="./assets/image/singapore.png" alt="Singapore Real Estate">Singapore
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a target="_blank" href="http://american-european.net/" title="Costa Rica Real Estate">
                                        <img src="./assets/image/costa-rica.png" alt="Costa Rica Real Estate">Costa Rica
                                    </a>
                                </li>
                                <li>
