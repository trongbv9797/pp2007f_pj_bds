...
<form id="boxSearchForm" action="/microservice-architecture-router/Product/ProductSearch/Index" method="post" novalidate="novalidate">
    <div class="search-bar shadow-lv-1 clearfix"><div class="search-guide" style="left: 985.083px; top: 64px; display: block;"><div class="icon-guide"><img src="http://127.0.0.1:8000/assets/image/ic_triangle.svg"></div>
	    </div>
        ...
        @foreach ($products as $products)
            <div class="vip0 product-item clearfix" uid="649852">
                <div class="product-image ">
                     <a class="product-avatar" href="{!! Route('nhadatchothue_single_post', $products->id) !!}" title="{!! $products->title !!}" onclick="">
                ...
                <div class="product-main">
                    <h3 class="product-title">
                        <a href="{!! Route('nhadatchothue_single_post', $products->id) !!}" title="{!! $products->title !!}" class="vipZero product-link">
                            {!! $products->title !!}
                        </a>
                    </h3>
...
<a pid="9169" href="https://batdongsan.com.vn/nha-dat-ban/p9169"><img src="http://127.0.0.1:8000/assets/image/ic_double_caret_right.png"></a>
</div>
