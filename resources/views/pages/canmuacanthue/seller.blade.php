...
@section('content')
    <div class="site-center">
        ...
        <div id="MiddleSubMenu">
            <div class="home-top-search" style="padding-bottom: 10px !important;">
                <div class="home-top-search-keyword">
                    <input type="text" placeholder="Nhập từ khóa để tìm theo cụm từ" id="txt1" class="txtKeyword" style='height: 23px; margin-top: 2px'>
                </div>
        ...
        <div class="body-left" style="740px">
        ...
        <div class="body-right" id="RightMainContent" style="width: 220px">
            <div>
