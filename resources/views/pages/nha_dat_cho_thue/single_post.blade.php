...
@section('styles')
<link rel="stylesheet" href="http://127.0.0.1:8000/assets/css/bien_hoa1.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/assets/css/bien_hoa2.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/assets/css/filestatic.ver202011121105.msvbds.FrontEnd.Product.ProductDetails.min.css">
...
<form id="boxSearchForm" action="https://batdongsan.com.vn/microservice-architecture-router/Product/ProductSearch/Index" method="post" novalidate="novalidate">
    <div class="search-bar shadow-lv-1 clearfix">
        ...
        <div id="link-reset" aria-label="Xóa tiêu chí lọc" data-microtip-position="bottom" role="tooltip"><img src="http://127.0.0.1:8000/assets/image/ic_reset.svg"></div>
    </div>
</form>
    ...
    <div class="slide-product" tabindex="0">
        <div class="swiper-container gallery-top swiper-container-initialized swiper-container-horizontal">
            <ul class="swiper-wrapper list-unstyled row" style="transform: translate3d(0px, 0px, 0px);">
                ...
                <!-- Add Arrows -->
                <div class="swiper-button-next slide-next1" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false"><img src="http://127.0.0.1:8000/assets/image/ic_carousel_caret_right.png"> </div>
                <div class="swiper-button-prev slide-prev1 swiper-button-disabled" tabindex="0" role="button" aria-label="Previous slide" aria-disabled="true"><img src="http://127.0.0.1:8000/assets/image/ic_carousel_caret_left.png"></div>
        ...
        <div class="swiper-container gallery-thumbs swiper-container-initialized swiper-container-horizontal swiper-container-free-mode swiper-container-thumbs">
            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                            ...
                            <img onmouseover="this.style.cursor=&#39;pointer&#39;" alt="{!! $products->title !!}" title="{!! $products->title !!}" error-image-src="https://staticfile.batdongsan.com.vn/images/mobile/NoImage.svg" src="http://127.0.0.1:8000/assets/image/20201111095750-3277_wm(1).jpg" is-lazy-image="true" lazy-id="3">
                        </div>
                        <div class="swiper-slide swiper-slide-visible swiper-slide-next" style="margin-right: 8px;">
                            <img onmouseover="this.style.cursor=&#39;pointer&#39;" alt="{!! $products->title !!}" error-image-src="https://staticfile.batdongsan.com.vn/images/mobile/NoImage.svg" src="http://127.0.0.1:8000/assets/image/20201111095757-9bf4_wm.jpg" is-lazy-image="true" lazy-id="4">
                        </div>
                        <div class="swiper-slide swiper-slide-visible" style="margin-right: 8px;">
                            <img onmouseover="this.style.cursor=&#39;pointer&#39;" alt="{!! $products->title !!}" title="{!! $products->title !!}" error-image-src="https://staticfile.batdongsan.com.vn/images/mobile/NoImage.svg" src="http://127.0.0.1:8000/assets/image/20201111095817-45e1_wm.jpg" is-lazy-image="true" lazy-id="5">
                        </div>
            </div>
        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
        <!-- Initialize Swiper -->
    ...
    <div id="popup">
        ...
        <div class="content">
            <div class="slide-content slide-3d">
                <iframe frameborder="0" width="840" height="473" scrolling="no" src="http://127.0.0.1:8000/assets/image/saved_resource(6).html" allowfullscreen=""></iframe>
            </div>
    ...
    <div class="short-detail-wrap">
        ...
        <div class="repost">
            ...
            <div class="box-share hidden">
                <ul>
                    <li>
                        <a id="facebook" target="_blank" rel="nofollow" href="https://www.facebook.com/sharer/sharer.php?u=https://batdongsan.com.vn/ban-dat-nen-du-an-pho-nam-cao-phuong-phuoc-tan-prj-bien-hoa-new-city/khach-ket-tien-can-ban-nhanh-lo-dt-5-x-20-6-x-20-12-x-20-da-nhan-so-pr27748072&amp;t=Kh%C3%A1ch%20k%E1%BA%B9t%20ti%E1%BB%81n%20c%E1%BA%A7n%20b%C3%A1n%20nhanh%20l%C3%B4%20%C4%91%E1%BA%A5t%20Bi%C3%AAn%20H%C3%B2a%20New%20City,%20DT%205%20x%2020m,%206%20x%2020m,%2012%20x%2020m,%20%C4%91%C3%A3%20nh%E1%BA%ADn%20s%E1%BB%95"><img src="http://127.0.0.1:8000/assets/image/ic_facebook.png">Facebook</a>
                    </li>
                    <li>
                        <div class="zalo-share-button" data-href="" data-oaid="579745863508352884" data-layout="2" data-color="blue" data-customize="true"><img src="http://127.0.0.1:8000/assets/image/ic_zalo.png">Zalo<iframe frameborder="0" allowfullscreen="" scrolling="no" width="0px" height="0px" src="http://127.0.0.1:8000/assets/image/share.html" style="position: absolute;"></iframe></div>
                    </li>
                    <li>
                        <a id="copyLink"><img src="http://127.0.0.1:8000/assets/image/ic_link.png">Sao chép liên kết</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="detail-product">
        <div class="detail-1 pad-bot-16">
            ...
            <div class="box-view-more hidden">
                ...
                <div class="view-more">Xem thêm<img src="http://127.0.0.1:8000/assets/image/ic_caret_down.svg"></div>
            </div>
            <div class="box-view-less hidden" style="display: block;">
                <div class="view-less">Thu gọn<img src="http://127.0.0.1:8000/assets/image/ic_caret_up.svg"></div>
            </div>
        </div>
        <div class="detail-2 pad-16">
            ...
            <div class="map">
                <iframe width="100%" height="246px" ignore-lazy-loading="" frameborder="0" style="border:0" src="http://127.0.0.1:8000/assets/image/place.html" allowfullscreen=""></iframe>
...
<script>
    ...
    <div class="sendContactContent">
        ...
        <div class="row text-center">
            <div><div class="grecaptcha-badge" data-style="none" style="width: 256px; height: 60px; position: fixed; visibility: hidden;"><div class="grecaptcha-logo"><iframe src="http://127.0.0.1:8000/assets/image/anchor(1).html" width="256" height="60" role="presentation" name="a-3u4gfsgp33hz" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><div class="grecaptcha-error"></div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;" src="http://127.0.0.1:8000/assets/image/saved_resource(7).html"></iframe></div><button class="g-recaptcha" data-sitekey="6Lf-hbgZAAAAAGWhpwOnaSnHeERaH7lqJ065rGM4" data-callback="onSubmit_FrontEnd_Product_Details_ContactBox_SendRequest" data-action="submit" onmouseover="this.style.cursor=&#39;pointer&#39;" id="btnSendRequest">Gửi yêu cầu</button>
        </div>
    </div>
</div>
<script>
...
<input type="hidden" value="0" id="vipOrder">
    ...
    <div class="list-product list-product-area pad-16">
        ...
        <div class="list-product-slide">
            ...
            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
            <div class="swiper-button-next slide-next" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false"><img src="http://127.0.0.1:8000/assets/image/slide-next.png"></div>
            <div class="swiper-button-prev slide-prev swiper-button-disabled" tabindex="0" role="button" aria-label="Previous slide" aria-disabled="true"><img src="http://127.0.0.1:8000/assets/image/slide-prev.png"></div>
        </div>
    </div>
<script type="text/javascript">
    (function callJQuery() {
                ...
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-928px, 0px, 0px);"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="3" style="width: 232px;"><div class="broker-wrap">
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/c-ty-tnhh-xay-dung-thuong-mai-moi-gioi-bat-dong-san-dat-viet-eb2712" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20190531173625-b770.jpg">
                                </a>
                            </div>
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/cong-ty-co-phan-dv-tm-xd-dia-oc-kim-oanh-eb2466" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180104105026-5581.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/cong-ty-co-phan-dau-tu-viet-hung-phat-eb2420" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20170825163101-f2fb.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/cong-ty-tnhh-dich-vu-bat-dong-san-dong-a-eb946" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/thumb200x200.2306.cong-ty-tnhh-dich-vu-bat-dong-san-dong-a.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                        ...
                        <div class="swiper-slide swiper-slide-duplicate-next" data-swiper-slide-index="0" style="width: 232px;"><div class="broker-wrap">
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/cong-ty-cp-kinh-doanh-dia-oc-dat-moi-eb2588" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180817111042-29df.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/vpdd-cong-ty-cppt-dia-oc-van-xuan-eb2538" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180618174008-4ee6.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohuhappyland-eb2512" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510151049-8b4b.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohuinternational-eb2511" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510142917-d740.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                        ...
                        <div class="swiper-slide" data-swiper-slide-index="1" style="width: 232px;"><div class="broker-wrap">
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohudona-eb2510" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510141326-909b.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohuhousing-eb2509" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510141042-e71d.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohuhcm-eb2508" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510140751-1857.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohumiennam-eb2507" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510140422-59d2.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                        ...
                        <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="2" style="width: 232px;"><div class="broker-wrap">
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohumiendong-eb2506" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510120438-a0e5.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohureal-eb2505" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510113359-da64.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/san-giao-dich-dohuland-eb1100" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20180510143557-2bfd.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
                            ...
                            <div class="broker-avatar">
                                <a href="https://batdongsan.com.vn/cong-ty-tnhh-xay-dung-thuong-mai-moi-gioi-bat-dong-san-dat-viet-eb2762" rel="nofollow">
                                                                            <img src="http://127.0.0.1:8000/assets/image/20191207111310-b5e7.jpg">
                                </a>
                            </div>
                            <div class="broker-info">
