...
@section('style-libraries')
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/assets/css/filestatic.msvbds.home.min.css">
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/assets/css/box.css">
@endsection
    ...
    <div class="new-home-2020">
                                    ...
                                    <div class="search-cate">
                                        ...
                                        <div id="divCatagoryReOptions" class="advance-select-options">
                                            <ul>
                                                ...
                                                <li vl="324"><span><img src="http://127.0.0.1:8000/assets/image/chungcu.png">Căn hộ chung
                                                        cư</span>
                                                </li>
                                                <li vl="362"><span><img src="http://127.0.0.1:8000/assets/image/nhaban.png">Các loại nhà
                                                        bán</span>
                                                ...
                                                <li vl="361"><span><img src="http://127.0.0.1:8000/assets/image/datban.png">Các loại đất
                                                        bán</span>
                                                    <ul style="min-width: 210px !important;">
                                                ...
                                                <li vl="44"><span><img src="http://127.0.0.1:8000/assets/image/trangtrai.png">Trang trại, khu
                                                        nghỉ
                                                        dưỡng</span></li>
                                                <li vl="45"><span><img src="http://127.0.0.1:8000/assets/image/khonhaxuong.png">Kho, nhà
                                                        xưởng</span>
                                                </li>
                                                <li vl="48"><span><img src="http://127.0.0.1:8000/assets/image/bdskhac.png">Bất động sản
                                                        khác</span>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="home-filter home-filter-1 slideClose">
                                    ...
                                    <div class="search-action search-action1">
                                        <a href="javascript:void(0)" class="m-r-10 filter-more">
                                            <img src="http://127.0.0.1:8000/assets/image/icon-down-arrow.png">
                                            Thêm
                                        </a>
                                        <a href="javascript:void(0)" class="action-reset-search-form">
                                            <img src="http://127.0.0.1:8000/assets/image/search-reset.png">
                                            Xóa
                                        </a>
                                    </div>
                                    <div class="clear"></div>
                                ...
                                <div class="home-filter home-filter-2 slideClose">
                                    ...
                                    <div class="search-action search-action2">
                                        <a href="javascript:void(0)" class="filter-less">
                                            <img src="http://127.0.0.1:8000/assets/image/up-arrow.png"> Thu gọn
                                        </a>
                                        <a href="javascript:void(0)" class="action-reset-search-form">
                                            <img src="http://127.0.0.1:8000/assets/image/search-reset.png"> Xóa
                                        </a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
            ...
            <div class="home-small-main">
                ...
                <div class="home-small-heading" id="hometabs">
                    ...
                    <a href="{{ Route('tintucbds') }}" id="tabview" class="home-small-more">Xem thêm tin tức<img
                            src="http://127.0.0.1:8000/assets/image/icon-arrow-right.png"></a>
                    <div class="clear"></div>
                </div>
                <div id="news-slide">
                        ...
                        <div class="home-small-main-1 news-show">
                            @foreach ($articles as $article)
                                <div id="hottab-{{ $i++ }}" class="" style="display: none;">
                                    ...
                                    <div class="news-time">
                                        <img src="http://127.0.0.1:8000/assets/image/clock.png">4 giờ trước
                                    </div>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="loveMoney102" positioncode="BANNER_POSITION_RIGHT_2020" style="margin-bottom: 0px">
                    <div class="adshared" rt="">
                        <div class="adshareditem aditem" time="15" style="display: none;"
                            ...
                            clr="false" k=""><iframe src="http://127.0.0.1:8000/assets/image/index_006.html" id="fr9921" scrolling="no"
                        ...
                        <div class="adshareditem aditem" time="15" style="display: block;"
                            ...
                            bid="11035" tip="" tp="7" w="250" h="250" isbg="false" clr="false" k=""><a
                                ...
                                target="_blank" title="" rel="nofollow"><img src="http://127.0.0.1:8000/assets/image/20201102141649-f304.jpg"
                    ...
                    <div class="adshared" rt="">
                        <div class="adshareditem aditem" time="15" style="display: none;"
                            ...
                            w="250" h="250" isbg="false" clr="false" k=""><a
                                ...
                                target="_blank" title="" rel="nofollow"><img src="http://127.0.0.1:8000/assets/image/20201104083546-b8ec.jpg"
                                    style="max-width: 100%; height:250px;" class="banner-img"></a></div>
                        <div class="adshareditem aditem" time="15" style="display: block;"
                            ...
                            h="250" isbg="false" clr="false" k=""><iframe src="http://127.0.0.1:8000/assets/image/index_007.html" id="fr11084"
        ...
        <div class="home-center bg-grey" id="interestedProductsBinnovaContent">
            ...
            <div class="home-product product-4-you">
                ...
                <div class="clear"></div>
                <link rel="stylesheet" href="http://127.0.0.1:8000/assets/image/microtip.css">
                <ul>
                ...
                <div id="ucHomeProductInterest_pnlViewMore">
                    <div class="home-viewmore">
                        <a href="javascript:void(0)" id="prd-viewmore">
                            Mở rộng&nbsp;&nbsp;<img src="http://127.0.0.1:8000/assets/image/icon-down-blue.png">
                        </a>
                        ...
                        <div class="place-img slick-initialized slick-slider">
                            <div aria-live="polite" class="slick-list draggable">
                                <div class="slick-track" style="opacity: 1; width: 1680px;" role="listbox"><img
                                        src="http://127.0.0.1:8000/assets/image/HCM-web-1.jpg" is-lazy-image="true" lazy-id="6"
                                        ...
                                        src="http://127.0.0.1:8000/assets/image/HCM-web-2.jpg" is-lazy-image="true" lazy-id="7"
                                        ...
                                        src="http://127.0.0.1:8000/assets/image/HCM-web-3.jpg" is-lazy-image="true" lazy-id="8"
                    ...
                    <div class="place-small">
                            ...
                            <div class="place-img slick-initialized slick-slider">
                                <div aria-live="polite" class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 810px;" role="listbox"><img
                                            src="http://127.0.0.1:8000/assets/image/HN-web-1.jpg" is-lazy-image="true" lazy-id="9"
                                            ...
                                            src="http://127.0.0.1:8000/assets/image/HN-web-2.jpg" is-lazy-image="true" lazy-id="10"
                                            class="slick-slide" data-slick-index="1" aria-hidden="true"
                                            ...
                                            src="http://127.0.0.1:8000/assets/image/HN-web-3.jpg" is-lazy-image="true" lazy-id="11"
                        ...
                        <div class="place-item">
                            <div class="place-img slick-initialized slick-slider">
                                <div aria-live="polite" class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 810px;" role="listbox"><img
                                            src="http://127.0.0.1:8000/assets/image/DDN-web-1.jpg" is-lazy-image="true" lazy-id="12"
                                            class="slick-slide" data-slick-index="0" aria-hidden="true"
                                            style="width: 270px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0; transition: opacity 500ms ease 0s;"
                                            tabindex="-1" role="option" aria-describedby="slick-slide20"><img
                                            src="http://127.0.0.1:8000/assets/image/DDN-web-2.jpg" is-lazy-image="true" lazy-id="13"
                                            class="slick-slide" data-slick-index="1" aria-hidden="true"
                                            style="width: 270px; position: relative; left: -270px; top: 0px; z-index: 998; opacity: 0; transition: opacity 500ms ease 0s;"
                                            tabindex="-1" role="option" aria-describedby="slick-slide21"><img
                                            src="http://127.0.0.1:8000/assets/image/DDN-web-3.jpg" is-lazy-image="true" lazy-id="14"
                                            class="slick-slide slick-current slick-active" data-slick-index="2"
                                            aria-hidden="false"
                                            style="width: 270px; position: relative; left: -540px; top: 0px; z-index: 999; opacity: 1;"
                            ...
                            <div class="place-img slick-initialized slick-slider">
                                <div aria-live="polite" class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 540px;" role="listbox"><img
                                            src="http://127.0.0.1:8000/assets/image/lazy-preview-image-DFE3E8.png"
                    ...
                    <ul class="swiper-wrapper" style="transform: translate3d(-3056px, 0px, 0px); transition-duration: 0ms;">
                        ...
                        <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next"
                            ...
                            <a href="https://batdongsan.com.vn/tu-van-moi-gioi-bat-dong-san-quan-5/cong-ty-tnhh-tm-dv-nha-ta-ep2777"
                                ...
                                <img class="color_flip" src="http://127.0.0.1:8000/assets/image/20200110153537-ce21.jpg"
                        ...
                        <li class="swiper-slide swiper-slide-duplicate" style="width: 261.25px; margin-right: 25px;"
                            ...
                            <div class="home-social-img">
                                <a href="https://dantri.com.vn/bat-dong-san/gia-condotel-lao-doc-20191212143023187.htm"
                                    ...
                                    <img src="http://127.0.0.1:8000/assets/image/lazy-preview-image-DFE3E8.png"
                        ...
                        <li class="swiper-slide swiper-slide-duplicate swiper-slide-prev"
                            ...
                            <div class="home-social-img">
                                <a href="https://baoxaydung.com.vn/dat-nen-van-la-kenh-dau-tu-hap-dan-trong-tuong-lai-269183.html"
                                    target="_blank'" rel="nofollow">
                                    <img style="max-height: 173px" src="http://127.0.0.1:8000/assets/image/B-02_BaoXayDung.jpg">
                                </a>
                            </div>
                            <div class="home-social-link">
                                <img style="max-height: 40px; max-width: 40px" src="http://127.0.0.1:8000/assets/image/icon_BaoXayDung.png">
                                <a href="https://baoxaydung.com.vn/dat-nen-van-la-kenh-dau-tu-hap-dan-trong-tuong-lai-269183.html"
                                    target="_blank'" rel="nofollow">
